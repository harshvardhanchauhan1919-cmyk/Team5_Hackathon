...
**Auto-repair rate: 0%** (0/4 initially-failed cases healed) — target >= 50% NOT MET
...
| checkout_performance_glitch_user | performance_glitch_user | timeout | fail | fail | 3 | no | None |
