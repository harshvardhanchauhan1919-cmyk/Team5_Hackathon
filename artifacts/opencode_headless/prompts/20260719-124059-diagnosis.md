...
live data-test attributes currently on page: about-sidebar-link, active-option, add-to-cart-sauce-labs-backpack, add-to-cart-sauce-labs-bike-light, add-to-cart-sauce-labs-bolt-t-shirt, add-to-cart-sauce-labs-fleece-jacket, add-to-cart-sauce-labs-onesie, add-to-cart-test.allthethings()-t-shirt-(red), close-menu, footer, footer-copy, header-container, inventory-container, inventory-item, inventory-item-desc, inventory-item-description, inventory-item-name, inventory-item-price, inventory-item-sauce-labs-backpack-img, inventory-item-sauce-labs-bike-light-img, inventory-item-sauce-labs-bolt-t-shirt-img, inventory-item-sauce-labs-fleece-jacket-img, inventory-item-sauce-labs-onesie-img, inventory-item-test.allthethings()-t-shirt-(red)-img, inventory-list, inventory-sidebar-link, item-0-img-link, item-0-title-link, item-1-img-link, item-1-title-link, item-2-img-link, item-2-title-link, item-3-img-link, item-3-title-link, item-4-img-link, item-4-title-link, item-5-img-link, item-5-title-link, logout-sidebar-link, open-menu, primary-header, product-sort-container, reset-sidebar-link, secondary-header, shopping-cart-link, social-facebook, social-linkedin, social-twitter, title
Screenshots captured: artifacts/engine_core/e2e_checkout__standard_user__attempt0.png
